...
def trim_DR_sequence_circle(genome, fields, output_dir, trim_len, id1, id2, rev_compl_DR):
    ...
    repeat1_start = int(float(fields[id1]['start']))    #repeat1_start = int(fields[id1]['start'])  
    repeat1_end = int(float(fields[id1]['end']))  
    repeat1_rev = False
    repeat2_rev = False
    # Check if repeat1_start is greater than repeat1_end
...
def trim_DR_sequence_linear(genome, fields, output_dir, trim_len, id1, id2, rev_compl_DR):
    ...
    repeat1_new_start = repeat1_start
    repeat1_new_end = repeat1_end
    repeat2_new_start = len(genome.seq[repeat1_end : repeat2_start-1])
...
################################################################################
    ...
    # 此处假设genome_sub2为环状
    upstream_length = repeat2_new_start
