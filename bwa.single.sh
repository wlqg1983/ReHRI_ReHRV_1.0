...
#echo "Copying reference genome to output directory..."
#cp "$reference" "$output_dir/$reference"
...
# Align reads to the reference genome and save in SAM format

#bwa mem -t "$threads" "$reference" "$input_fastq" > "$output_dir/output.sam"

# Remove BWA index files
#echo "Removing BWA index files..."
