...
def process_data_user_color(data, genome_length, output_file, user_color_input):
    ...
    for index, row in data.iterrows():
        ...
        angle = (length / genome_length) * 330
    ...
    with open(color_file_path, 'r') as color_file:
        for line in color_file:
            ...
            for color_setting in color_settings:
                ...
                if len(parts) != 2:
                    print(f"Custom color format in the file is incorrect. Use 'tag:color' format. Or check that the word describing the colour is spelled correctly.")
